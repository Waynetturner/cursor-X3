...
export default function MeasurementsPage() {
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#D32F2F] via-[#FF6B35] to-[#FFC107] flex items-center justify-center">
        <div className="bg-white/10 backdrop-blur-lg text-white border border-white/20 rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold mb-4">Loading...</h2>
          <p>Please sign in to track measurements</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#D32F2F] via-[#FF6B35] to-[#FFC107]">
      <div className="container mx-auto px-4 py-8">
        <header className="flex items-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">Record Measurements</h1>
        </header>
